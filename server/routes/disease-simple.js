// Simple bilingual email template for disease alerts
// This is a simplified version that works well in all email clients

const createSimpleEmailTemplate = (user, disease, description, location) => {
  return `
<!DOCTYPE html>
<html>
<head>
...
const createSimpleTextEmail = (user, disease, description, location) => {
  return `
